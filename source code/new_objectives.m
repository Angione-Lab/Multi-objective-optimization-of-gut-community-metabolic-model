% setting new objectives for flux balance analysis
...
% select indices for new objectives with corresponding rxn indices in the model
ix_new_f = 286;
ix_new_g = 1703;
ix_new_h = 3260;
ix_new_i = 5647;
...
% erase old indices to 0 to deselect old objectives
modelJoint.f(ix_f) = 0;
modelJoint.g(ix_g) = 0;
modelJoint.h(ix_h) = 0;
modelJoint.i(ix_i) = 0;
...
% set new indices to 1 to select new objectives
